...
## Directory Structure
- All music ratings should be stored in the `music/ratings` directory.
## File Naming
...
## Linking
- reflection ratings are stored in `music/ratings/reflections`.
## File Naming
- Use lowercase letters and hyphens for file names (e.g., `my-first-rating.html`).
## Ratings
...
- Ensure all internal links are relative and point to the correct files within the `music/ratings` directory.
## Styling
